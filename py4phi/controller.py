...
class Controller:
    ...
    def encrypt(self, columns_to_encrypt: list[str]):
        """
        ...
        self._current_df = self.__encryptor.encrypt()

    def decrypt(self, columns_to_decrypt: list[str]):
        """
        ...
        self._current_df = self.__encryptor._decrypt()
